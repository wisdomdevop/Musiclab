  ...
  return (
    <div className='bg-zinc-800 text-white font- fixed z-[100%] w-[100%] top-0 flex flex-col '>
        <section className={`flex lg:justify-around p-4 text-white justify-between ${openNavigation? "items-start": "items-center"} py-2`}>
            <div className={`${openNavigation? "mt-3.5": "mt-0"} lg:mt-0`}>
            ...
            <div className={`${openNavigation? "flex animate-slideIn": "hidden"}  items-center justify-center flex-col h-[300px] gap-5 font-montserrat font-medium text-base lg:hidden bg-transparent`}>
